...
SECRET_KEY = 'django-insecure-u94yalk5h0opwa0w+re68=%!_h^mkm-kdi-joboaj*!sj6o3eo'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['penvis.ir', 'www.penvis.ir']
...
# منطقه زمانی تهران (اختیاری ولی مفید برای تاریخ‌ها):
