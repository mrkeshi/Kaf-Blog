<template>
   <article class="mt-2">
            ...
            <div class="FooterArticle">
                <NuxtLink :to="`${post.slug}`" href="#" class="inline-block float-left px-4 py-1.5 text-sm font-semibold text-black-400 border border-black-400 rounded-full transition-all duration-300 hover:bg-blue-600 hover:text-white">
                    ادامه مطلب
                  </NuxtLink>
                              </div>
        </article>
