...
{{ post?.title }}
            ...
            <div class="flex items-center my-4 max-md:my-1 justify-center gap-8 max-md:gap-1 bg-black-100 rounded-full  w-full h-20 mb-4 ">
                <div class="flex items-center flex-wrap">
                    <svg width="22" height="22" class="fill-blue-600" viewBox="0 0 24 24" stroke="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <path d="M7 11H9V13H7V11ZM19 4H18V2H16V4H8V2H6V4H5C3.89 4 3.01 4.9 3.01 6L3 20C3 21.1 3.89 22 5 22H19C20.1 22 21 21.1 21 20V6C21 4.9 20.1 4 19 4ZM19 20H5V10H19V20ZM19 8H5V6H19V8ZM15 11H17V13H15V11ZM11 11H13V13H11V11Z"></path>
                        </g>
                        <defs>
                ...
                <div class="flex items-center">
                    <svg width="17" height="17" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <path d="M16.4925 1.5H1.5V13.5H13.5L16.5 16.5L16.4925 1.5ZM13.5 10.5H4.5V9H13.5V10.5ZM13.5 8.25H4.5V6.75H13.5V8.25ZM13.5 6H4.5V4.5H13.5V6Z" class="fill-blue-600"></path>
                        </g>
                        <defs>
